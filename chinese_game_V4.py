...
#判斷王見王
def king():
    if hongqi[0,hongqi[each_qizi]['now_weizhi'][1]] == heiqi[0,heiqi[each_qizi]['now_weizhi'][1]]:
        while hongqi[0,hongqi[each_qizi]['now_weizhi'][0]] <= heiqi[0,heiqi[each_qizi]['now_weizhi'][0]]:
            hongqi[0,hongqi[each_qizi]['now_weizhi'][0]] += 90
            if weizhi_panduan(hongqi[0,hongqi[each_qizi]['now_weizhi'][0]], honqi[0,honqi[each_qizi]['now_weizhi'][1]]):
                return false
        return true
