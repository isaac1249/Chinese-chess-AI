...
def Draw_a_chessboard(screen):
    ...
    text3 = s_font.render("重新開始",True,button_color)
    text4 = s_font.render("退出遊戲",True,button_color)
...
def main():
    ...
    hongqi_trans = {'0':{'color':'red','now_weizhi':[90,450]},'1':{'color':'red','now_weizhi':[90,360]},'2':{'color':'red','now_weizhi':[90,540]},'3':{'color':'red','now_weizhi':[90,270]},
                    '4':{'color':'red','now_weizhi':[90,630]},'5':{'color':'red','now_weizhi':[90,180]},'6':{'color':'red','now_weizhi':[90,720]},'7':{'color':'red','now_weizhi':[90,90]},
                    '8':{'color':'red','now_weizhi':[90,810]},'9':{'color':'red','now_weizhi':[270,180]},'10':{'color':'red','now_weizhi':[270,720]},'11':{'color':'red','now_weizhi':[360,90]},
                    '12':{'color':'red','now_weizhi':[360,270]},'13':{'color':'red','now_weizhi':[360,450]},'14':{'color':'red','now_weizhi':[360,630]},'15':{'color':'red','now_weizhi':[360,810]}
                  }
    heiqi_trans = {'0':{'color':'black','now_weizhi':[900,450]},'1':{'color':'black','now_weizhi':[900,360]},'2':{'color':'black','now_weizhi':[900,540]},'3':{'color':'black','now_weizhi':[900,270]},
                   '4':{'color':'black','now_weizhi':[900,630]},'5':{'color':'black','now_weizhi':[900,180]},'6':{'color':'black','now_weizhi':[900,720]},'7':{'color':'black','now_weizhi':[900,90]},
                   '8':{'color':'black','now_weizhi':[900,810]},'9':{'color':'black','now_weizhi':[720,180]},'10':{'color':'black','now_weizhi':[720,720]},'11':{'color':'black','now_weizhi':[630,90]},
                   '12':{'color':'black','now_weizhi':[630,270]},'13':{'color':'black','now_weizhi':[630,450]},'14':{'color':'black','now_weizhi':[630,630]},'15':{'color':'black','now_weizhi':[630,810]}
                  }
    ...
    while True: 
        ...
        if working:
                        ...
                        if running:
                            ...
                            if order:
                                #print(hongqi.keys())
                                rand_choose = str( random.randint(0, len(hongqi)-1))
                                x = hongqi_trans[rand_choose]['now_weizhi'][0]
                                y = hongqi_trans[rand_choose]['now_weizhi'][1]
                                    
                            else:
                                rand_choose = str( random.randint(0, len(heiqi)-1))
                                x = heiqi_trans[rand_choose]['now_weizhi'][0]
                                y = heiqi_trans[rand_choose]['now_weizhi'][1]
